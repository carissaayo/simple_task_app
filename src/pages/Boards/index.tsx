...
const Home = () => {
  ...
  return (
    <>
      ...
      >
        <div className="w-full flex items-start justify-between px-5 pb-8  gap-10 md:gap-16">
              ...
              <Droppable droppableId={columnId} key={columnId}>
                {(provided: any) => (
                  <div
                    ...
                    className="flex flex-col md:min-w-[290px] min-w-[250px] gap-3 items-center py-5"
                  >
